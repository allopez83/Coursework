...
blockMult:    # Block Matrix Multiplication Code
	...
	move  $s0, $t5         # 1st loop layer - Y axis of matrix 1 with predefined offsets
L11:	move  $s1, $t6         # 2nd loop layer - X axis of matrix 2 with predefined offsets
L12:	move  $s2, $t7         # 3rd loop layer - X axis of matrix 1 and Y axis of matrix 2 - Calculation offset with predefined offsets
	# Data loading for matrix 2
