...
public class CalendarExample
{
   ...
   public static void printCalendar(Calendar c)
   {
      ...
      GregorianCalendar temp = new GregorianCalendar(c.get(Calendar.YEAR),
            c.get(Calendar.MONTH), 1);
      System.out.println("The first day of this month is "
            + arrayOfDays[temp.get(Calendar.DAY_OF_WEEK) - 1]);
   }
}
