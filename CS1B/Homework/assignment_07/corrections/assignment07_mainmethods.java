 ...
 * @author HW
 */
public class Assignment07_MainMethods {
	 ...
	 * @param file name of file that will be created; directory can be added
	 */
	 ...
	 * @param empl Employee that will be written into file
	 */
	 ...
	 * @return Employee read from stream opened by startReading() method
	 */
	...
	public static void main(String[] args) {
		...
		/* 
		 * Conducting test on getEmployee() and changeEmployee()
		...
		// Set to null
		listedEmployees = null;
		listedEmployees = new EmployeeList(3);
