...
public class Employee implements Comparable<Employee>, Serializable {
	...
	/**
	 * Returns data in an Employee object as a string
	 */
	...
	/**
	 * Compares two Employee objects by their name and returns an integer representation of the comparison
	 */
	...
	/**
	 * Raises an employee's salary by a given percent
	 * @param raisePercent percent by which to raise the salary; to raise 25% enter 0.25
	 */
