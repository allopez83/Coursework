...
public class GUIApp extends JFrame implements ActionListener {
	...
	private static final int WINDOW_WIDTH = 600,
							 WINDOW_HEIGHT = 290,//TODO set correct size
	...
	public GUIApp() {
		setContentPane(windowContent());	//TODO verify what this does
	...
	public void actionPerformed(ActionEvent e) {
		if (TESTING_ACTION) System.out.println(" > Registered action performed");
