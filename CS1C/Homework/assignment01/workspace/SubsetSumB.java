...
public class SubsetSumB
{
   public static void main(String[] args) throws Exception
   {
      ...
      Sublist list = new Sublist(masterList), perfectList = null;
   ...
   static class Sublist implements Cloneable
   {
      ...
      void showList()
      {
         ...
         {
            System.out.println("[" + k + "] : " + originalObjects.get(indices.get(k)));
         }
      }
   }
}
...
Algorithm Elapsed Time: 0.0978 seconds.
