package assignment08.workspace;
...
public class RecursionAnalysis
{
   ...
   public static void main(String[] args)
   {
      ...
      for (k = 0; k < ARRAY_SIZE; k++)
      {
         ...
         // Go through each of the arrays in intArray
      ...
      arrayTest("Limit of 2 test (1):", 2, intArray);
      arrayTest("Limit of 2 test (2):", 2, intArray);
      arrayTest("Limit of 2 test (3):", 2, intArray);
      // Actual tests
