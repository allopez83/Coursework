...
route(Departing, Arriving, Visited, DepartureTime, ArrivalTime, Flights, TotalCost) :-
  ...
  print("Append"),
  append(Visited, [Transfer], V),
  route(Transfer, Arriving, V, TransferArrival, ArrivalTime, TailFlights, TailCost), % Rest of the flight path
...
% route(lax, sjc, Visited, DepartureTime, ArrivalTime, Flights, TotalCost).

% One intermediate jump
% route(sfo, sjc, Visited, DepartureTime, ArrivalTime, Flights, TotalCost).
